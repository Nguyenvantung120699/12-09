          ...
          <div class="table-responsive" style="background-color: #E6E6E6;border-radius: 10px;">
            ...
            <thead>
              <tr>
                ...
                <th scope="col">
                    <a href="{{url('admin/productattribute/create')}}">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{url('admin/productattribute/detail',['id'=>$c->id])}}"><button type="button" class="btn btn-info"><i class="fa fa-eye" aria-hidden="true"></i> Xem</button></a>
                    <a href="{{url('admin/productattribute/edit',['id'=>$c->id])}}"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</button></a>
                    <a id="deletebtn" href="{{url('admin/productattribute/delete',['id'=>$c->id])}}"><button type="button" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i> Xóa</button></a>
                  </div>
                </td>
              </tr>
              @endforeach
