          ...
          <div class="table-responsive" style="background-color: #E6E6E6;border-radius: 10px;">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$c->name}}</td>
                <td>
                   <img style="width: 100px;height: 100px;border-radius: 5%" id="logo" src="{{asset("$c->logo")}}" alt="your image"/>
                </td>
                <td>
                   @if($c->status == 1)
                     Hoạt Động
                ...
                <td>
                  <div class="btn-group">
                    <a href="{{url('admin/products/detail',['id'=>$c->id])}}"><button type="button" class="btn btn-info"><i class="fa fa-eye" aria-hidden="true"></i> Xem</button></a>
                    <a href="{{url('admin/products/edit',['id'=>$c->id])}}"><button type="button" class="btn btn-warning"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sửa</button></a>
                    <a id="deletebtn" href="{{url('admin/products/delete',['id'=>$c->id])}}"><button type="button" class="btn btn-danger"><i class="fa fa-trash-o" aria-hidden="true"></i> Xóa</button></a>
                  </div>
                </td>
              </tr>
              @endforeach
